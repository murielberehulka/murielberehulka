...
set mouse=aset encoding=utf-8
filetype plugin indent on
syntax onset encoding=utf-8
filetype plugin indent on
syntax on
set clipboard=unnamed
set completeopt=noinsert,menuone,noselect
...
nnoremap <F2> :!cargo run --bin second --release<CR> 
inoremap <F1> <Esc>:! cargo run --release<CR>
inoremap <F2> <Esc>:! cargo run --bin second --release<CR>
...
inoremap <F1> <Esc>:! cargo run --bin second --release<CR>
inoremap <F2> <Esc>:! cargo run --bin second --release<CR>
